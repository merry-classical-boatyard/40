...
-- : the CoeTail instances below might be addressing this comment, at least approximately.
-- TODO(dsk):
...
-- Note(): superceded by ExpressionTree
...
-- Note(): it's not clear how to write the HMul instances...
